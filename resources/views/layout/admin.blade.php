    ...
    <aside class="w-72 bg-black text-white">
      <div class="sticky top-0 h-screen">
        <div class="flex flex-col h-full p-5 overflow-y-auto">
          ...
          <div class="flex-1">
            ...
            <nav class="flex flex-col gap-3">
              ...
              <a href="/admin/product/add"
                class="py-2 px-3 flex items-center gap-2 {{ request()->is('admin/product/add*') ? $activeClass : $normalClass }}">
              ...
              <a href="/admin/product/edit"
                class="py-2 px-3 flex items-center gap-2 {{ request()->is('admin/product/edit*') ? $activeClass : $normalClass }}">
              ...
              <a href="/admin/category/add"
                class="py-2 px-3 flex items-center gap-2 {{ request()->is('admin/category/add*') ? $activeClass : $normalClass }}">
              ...
              <a href="/admin/category/edit"
                class="py-2 px-3 flex items-center gap-2 {{ request()->is('admin/category/edit*') ? $activeClass : $normalClass }}">
          ...
          <div class="pt-6">
            <a href="/logout" class="flex items-center gap-3 py-3 px-3 opacity-60 hover:opacity-100">
