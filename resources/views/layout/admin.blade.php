  ...
  <div class="flex h-screen overflow-hidden">
    <aside class="w-72 bg-black text-white">
      <div class="sticky top-0 h-screen">
        <div class="flex flex-col h-full py-5 px-4 overflow-y-auto">
          ...
          <div class="flex-1">
            ...
            @php
              $activeClass = 'bg-white text-black py-3 rounded-lg';
              $normalClass = 'text-white py-3 hover:bg-white rounded-lg hover:text-black transition-colors';
            @endphp
